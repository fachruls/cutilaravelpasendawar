...
<div class="container pb-5">
    <div style="background: linear-gradient(135deg, #107c41 0%, #0a5c30 50%, #064020 100%); border-radius: 20px; padding: 24px 30px; color: white; position: relative; overflow: hidden; margin-bottom: 24px; box-shadow: 0 8px 30px rgba(16, 124, 65, 0.25);">
        ...
        <i class="fas fa-calendar-alt" style="position: absolute; right: 30px; top: 50%; transform: translateY(-50%); font-size: 4rem; opacity: 0.1;"></i>
        <h4 class="fw-bold m-0" style="position: relative; z-index: 1;"><i class="fas fa-calendar-alt me-2"></i>Kalender Cuti</h4>
        <p class="m-0 mt-1" style="opacity: 0.85; font-size: 0.9rem; position: relative; z-index: 1;">Pantau jadwal cuti seluruh pegawai.</p>
    </div>
